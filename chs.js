...
var cnItems = {
    ...
    "Play A Game": "玩个游戏",
    "playing Existence Simulator.": "玩存在模拟器。",
    "read": "读",
    ...
    "Costs 200 Knowledge and 200 Missed Opportunities. Blog Posts and Podcast Episodes generate 25% more Influence. Prerequisite to writing 'Existence Simulator,' an idle clicker game that will take over the world.": "花费 200 知识和 200 错失机会。博客文章和播客剧集产生的影响力增加了 25%。编写“”的先决条件，这是一款将接管世界的放置点击游戏。",
    ...
    "> You've purchased your own home. Your max anxiety has increased from 1,000 to 100,000.": "> 您已经购买了自己的房屋。 您的最大焦虑已从 1,000 增加到 100,000。",
    "> 😆 You have created a whole genre of ASMR for clicker games where people from all over the world quietly and kindly play your games with their face very close to a microphone.": "> 😆 你已经为点击游戏创造了一个完整的 ASMR 类型，来自世界各地的人们安静而亲切地玩你的游戏，他们的脸非常靠近麦克风。",
    "> You've purchased Inland Haze, a pure indica strain from Doober, the cannabis delivery service.": "> 您从香烟递送服务公司 Doober 购买了 Inland Haze，这是一种纯籼稻品种。",
    "You own a small home.": "你拥有了一个小房子。",
    "> Getting high still helps, but it's getting harder to get and stay high. 😫": "> 变高仍然有帮助，但要保持高水平变得越来越难。 😫",
    "> 😵‍💫🤩 Your YouTube channel has a growing catalog of paylists about the Existence Simulator, which is generating more Influence.": "> 😵‍💫🤩 您的 YouTube 频道有越来越多关于存在模拟器的付费列表，这正在产生更多影响力。",
    "> 😆 You've signed a sponsorship contract with Idle Wild Energy, makers of the Inverted Idler, a caffeinated beverage marketed toward idle clicker gamers.": "> 😆 您已与 Inverted Idler 的制造商 Idle Wild Energy 签订了赞助合同，这是一种面向放置点击游戏玩家的含咖啡因饮料。",
    "> The Existence Simulator has been at the top of every Best Of list, but it's not enough. You need *every* person on Earth playing Existence Simulator. Hire a research firm to figure out how to get more players.": "> 存在模拟器 一直在每个 最佳列表中名列前茅，但这还不够。 你需要地球上的每个人都在玩《存在模拟器》。 聘请一家研究公司来弄清楚如何获得更多玩家。",
    "> You've hired the Business for Idle Research in Clicker Heuristics (BIRCH). They have researchers all over the world who will find out exactly how to increase Worldwide Players of Existence Simulator.": "> 您已聘请 Business for Idle Research in Clicker Heuristics (BIRCH)。 他们在世界各地都有研究人员，他们将确切地了解如何增加全球存在模拟器玩家。",
    "Studying Existence Simulator players and non-players...": "研究存在模拟器玩家和非玩家...",
    "> The results are in: people don't have enough time during the day to play Existence Simulator! Use your Influence to help pass laws that give people more time to play Existence Simulator.": "> 结果在：人们白天没有足够的时间玩存在模拟器！ 利用你的影响力帮助通过法律，让人们有更多时间玩《存在模拟器》。",
    "Speaking at the Armed Services Committee hearing...": "在军事委员会听证会上发言...",
    "Speaking at the Agriculture Committee hearing...": "在农业委员会听证会上发言...",
    "Speaking at the Financial Services Committee hearing...": "在金融服务委员会听证会上发言...",
    "> You've purchased Alligator Sprinkles, a pure indica strain from Doober, the cannabis delivery service.": "> 您从香烟递送服务公司 Doober 购买了 Alligator Sprinkles，这是一种纯籼稻品种。",
    "> 🗳️ You helped pass a law that requires K-12 schools to teach idle clicker games. The Existence Simulator will be pre-installed on all computers in classrooms.": "> 🗳️ 您帮助通过了一项法律，要求 K-12 学校教授闲置的答题器游戏。 存在模拟器将预装在教室的所有计算机上。",
    "> 🗳️ With your help, the government has passed a law making Idle Gaming an official sport. Colleges have sixty days to create idle clicker teams and to provide accomodations for idle game leagues and Existence Simulator trainers.": "> 🗳️ 在您的帮助下，政府通过了一项法律，将 Idle Gaming 列为官方运动。 大学有 60 天的时间来创建闲置的答题器团队，并为闲置的游戏联赛和存在模拟器培训师提供住宿。",
    "> Every single person on Earth is playing Existence Simulator. Congratulations. We hope you enjoyed this highly accurate simulation of existence.": "> 地球上的每一个人都在玩生存模拟器。 恭喜。 我们希望您喜欢这种高度精确的存在模拟。",
    "> 🗳️ You helped pass a law that requires all public-access television and every major streaming service to provide livestreams of Existence Simulator free of charge.": "> 🗳️ 你帮助通过了一项法律，要求所有公共电视和所有主要的流媒体服务都免费提供 存在模拟器 的直播。",
    "> 🗳️ You helped pass a law that gives new parents a free Baby Existence Simulator Trainer (BEST) for their newborn, creating a whole new generation of Existence Simulator players.": "> 🗳️ 您帮助通过了一项法律，为新生儿父母提供免费的婴儿生存模拟器训练器 (BEST)，创造了全新一代的生存模拟器玩家。",
    "> 🗳️ You helped pass a law that provides housing stipends for citizens playing Existence Simulator. Now more people can play thanks to their government providing a safety net of basic necessities like shelter.": "> 🗳️ 你帮助通过了一项为玩《存在模拟器》的公民提供住房津贴的法律。 现在更多的人可以玩，这要归功于他们的政府提供了一个基本必需品的安全网，比如避难所。",
    "> 🗳️ You helped pass a law that provides free childcare for people who play Existence Simulator. More people are able to play your game because they don't have to worry about arranging for childcare; vetted, certified, and trained government employees will come to your house and watch your kids while you work.": "> 🗳️ 您帮助通过了一项为玩《存在模拟器》的人提供免费托儿服务的法律。 更多人可以玩您的游戏，因为他们不必担心安排托儿服务； 经过审查、认证和培训的政府雇员会在您工作时到您家看孩子。",
    "> 🗳️ You helped pass a law that provides free food rations to people when they play Existence Simulator. More people are able to play your game because they don't have to worry about where their food will come from.": "> 🗳️ 你帮助通过了一项法律，在人们玩生存模拟器时向他们提供免费食物配给。 更多的人能够玩你的游戏，因为他们不必担心他们的食物来自哪里。",
    "> 🗳️ Oh no! The Universal Income law had full government support but was VETOED at the last minute! There's only one way to get around this: You have to run for President of the World.": "> 🗳️ 哦不！ 全民收入法得到了政府的全力支持，但在最后一刻被否决了！ 只有一种方法可以解决这个问题：你必须竞选世界总统。",
    "> 🗳️ You helped pass a law that provides healthcare rebates to people playing Existence Simulator. More people are able to play since they don't have to keep a job solely for access to quality medical care.": "> 🗳️ 你帮助通过了一项为玩《存在模拟器》的人提供医疗保健回扣的法律。 更多的人能够玩，因为他们不必仅仅为了获得优质的医疗服务而保住工作。",
    "": "",
    "": "",
    "": "",
    "": "",
