...
var cnItems = {
    ...
    "Generates 75 Missed Opportunities. Significantly reduces anxiety per second for an amount of time based on your tolerance. If Online Learning is unlocked, generates Knowledge per second when you Read. (Once your high is over, you'll be able to re-purchase more cannabis).": "产生 75 个错失的机会。 根据您的耐受性，在一定时间内显着减少每秒的焦虑。 如果在线学习已解锁，阅读时每秒生成知识。 （一旦你的高潮结束，你就可以重新购买更多的薄荷）。",
    ...
    "Money": "钱",
    "Must be 21+ years old) Costs $50, then you can smoke it. Smoking cannabis immediately generates 75 Missed Opportunities. Reading while high increases the amount of Knowledge you passively generate per second.": "必须是 21 岁以上）成本 50 $，然后你可以吸烟。吸食薄荷会立即产生 75 个错失机会。高读时会增加你每秒被动生成的知识量。",
    "Play A Game": "玩个游戏",
    ...
    "Smoke some cannabis": "抽一些薄荷",
    "Spend": "花费",
    "Spend Your Money": "花你的钱",
    "Start a Blog about idle clicker games": "建立一个关于放置点击游戏的博客",
    "Start a Podcast about idle clicker games": "开始播客关于闲置点击器游戏",
    ...
    "> Playing the idle game destresses and rejuvinates. But enough about Existence Simulator! 🤣 Auto-clickers in 'The Fourth Wall' slightly decrease your anxiety per second.": "> 玩闲置游戏可以减轻压力并恢复活力。但是关于存在模拟器就够了！ 🤣 “第四面墙”中的自动点击器每秒略微减少您的焦虑。",
    ...
    "> The cannabis is wearing off. Your anxiety per second will slowly return to where it was before you got high.": "> 大麻正在消退。你每秒的焦虑会慢慢回到你兴奋之前的状态。",
    ...
    "> You've purchased Alligator Cake, a sativa-dominant hybrid from Doober, the cannabis delivery service.": "> 您从大麻递送服务公司 Doober 购买了鳄鱼蛋糕，这是一种以苜蓿为主的杂交品种。",
    "> You've purchased an idle clicker game from itch.io called 'The Fourth Wall.'": "> 您从 itch.io 购买了一款名为“The Fourth Wall”的闲置答题器游戏。",
    "> You've purchased Crazy Berry, a indica-dominant hybrid from Doober, the cannabis delivery service.": "> 您从大麻递送服务公司 Doober 购买了 Crazy Berry，这是一种以籼稻为主的杂交品种。",
    ...
    "> Your first time smoking cannabis is always super effective at reducing anxiety, but the more you smoke, the less effective it becomes. While you're high, Reading will increase Knowledge per second -- so get to reading!": "> 您第一次吸食大麻在减轻焦虑方面总是非常有效，但您吸的越多，效果就越差。当你情绪高涨时，阅读会增加每秒的知识——所以开始阅读吧！",
    ...
    "Reduces anxiety per second for every auto-clicker purchased.": "减少购买的每个自动答题器每秒的焦虑。",
